...
public class PhysicalObject {
	...
	public void setRandomParameters() {
		...
		double x = Tools.getPositiveDouble(containerComponent.getCanvasWidth());
		double y = Tools.getPositiveDouble(containerComponent.getCanvasHeight());
		setPosition(x, y);
		// limit the size of the object
		double width = Tools
				.getPositiveDouble(containerComponent.getCanvasWidth() / 2);
		double height = Tools
				.getPositiveDouble(containerComponent.getCanvasHeight() / 2);
